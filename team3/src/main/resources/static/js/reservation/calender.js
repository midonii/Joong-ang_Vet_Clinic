...
function new_event(event) {
	...
	//이벤트가 발생하면 해당 이벤트에 대한 정보가 이 핸들러 함수로 전달
	//click이 발생하면 클릭된 요소정보가 click 핸들러 함수로 전달
	//data 속성을 통해 date 변수에 값을 전달
        var date = event.data.date;
