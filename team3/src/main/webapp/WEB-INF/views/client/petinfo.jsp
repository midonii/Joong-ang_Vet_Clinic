				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="mb-1 col-7"
							style="line-height: 50px; font-size: 13px;">
						...
						<div
							class="d-none d-inline-block form-inline mb-3 navbar-search float-right col-5">
										...
										<c:forEach items="${petInfo }" var="pi">
											<div class="list-group list-group-flush">
												...
												<div class="list-group-item row">
													...
													<div class="col-4 float-left text-sm"
														style="margin-left: -40px" id="yearPlusMonth">(${pi.pet_Ym })</div>
												</div>
												<div class="list-group-item row">
							...
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary">
										접종 <i class="fa-regular fa-file-excel float-right s20"
											id="excel-down" title="excel 다운로드"></i>
									</h6>
								</div>
								<div class="card-body">
									<div style="height: 430px;">
										...
										<c:forEach items="${petChart }" var="ch" varStatus="status">
											<div class="accordion-item">
												<h2 class="accordion-header" id="${ch.chart_date }">
													...
													<button class="accordion-button collapsed pastChart"
														type="button" data-toggle="collapse"
														data-target="#A${ch.chart_no }"
														aria-expanded="${status.index eq 0 ? 'true':'false'}"
														aria-controls="A${ch.chart_no }" value="${ch.chart_no}">
												...
												<div id="A${ch.chart_no }"
													class="${status.index eq 0 ? 'accordion-collapse collapse':'accordion-collapse collapse'}"
													aria-labelledby="${ch.chart_date }"
														...
														<div class="card mb-4">
															<div class="card-body">
																<div class="d-flex justify-content-center">
																	<div
																		class="text-sm font-weight-bold text-info text-uppercase mb-3 ">
																		처방 상세 내역</div>
																</div>
																<div class="table-responsive">
																	<div id="clientScroll">
																		<table
																			...
																			<tbody id="client-table${ch.chart_no }"
																				data-spy="scroll" data-target="#list-example"
